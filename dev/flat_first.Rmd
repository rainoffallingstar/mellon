...
fusen::fill_description(
  ...
  fields = list(
    Title = "mellon",
    Description = "A Set of shiny tools created by rainoffallingstar.",
    `Authors@R` = c(
...
```{r function-survival_assistant}
#' survival_assistant
#' 
#' survival_assistant in shiny
#' 
#' @return shiny
#' 
#' @export
survival_assistant <- function(){
# 加载必要的包
library(shiny)
library(readxl)
library(survival)
...
```{r function-origene_primer_search}
#' origene_primer_search
#' 
...
```{r example-origene_primer_search}
origene_primer_search(gene = "itga9",
                                      speice = "Human",
                                      use_ncbi = F)
```
  
```{r tests-origene_primer_search}
